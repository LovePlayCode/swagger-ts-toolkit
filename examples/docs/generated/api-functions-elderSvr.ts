// 🤖 基于Swagger自动生成的API调用函数 - elderSvr
// ⚠️  请勿手动修改此文件
// 📅 生成时间: 2025-11-07T09:00:42.025Z
...
// 导出类型定义
export type elderSvrApiType = typeof elderSvrApi;
...
/*
// 方式1: 使用默认配置（自动初始化）
import { elderSvrApi } from './elderSvr';

// 方式2: 自定义配置
import { elderSvrApi, configureApiClient } from './elderSvr';
configureApiClient({
